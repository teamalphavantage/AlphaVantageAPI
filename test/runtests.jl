...
function download_weekly_adjust_appl_sts_test()
    ...
    data_type = :json
    outputsize = :compact
    api_call_result = execute_sts_adjust_weekly_api_call(user_model, stock_symbol; data_type = data_type, outputsize = outputsize, logger=nothing)
...
function download_weekly_adjust_appl_sts_with_logging_test()
    ...
    data_type = :json
    outputsize = :compact
    api_call_result = execute_sts_adjust_weekly_api_call(user_model, stock_symbol; data_type = data_type, outputsize = outputsize, logger=simple_logger)
...
@testset "execute_sts_adjusted_api_call_set" begin
    #@test download_monthly_appl_sts_test() == true
    @test download_weekly_adjusted_appl_sts_with_logging_test() == true
end
